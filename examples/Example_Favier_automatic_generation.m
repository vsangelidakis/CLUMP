...
% inputGeom='ParticleGeometries/Ellipsoid_R_2.0_1.0_0.5.stl';	N=10; chooseDistance='avg'; output='FA_Ellipsoid_2.0_1.0_0.5.txt';	visualise=true;
inputGeom='ParticleGeometries/Ellipsoid_R_2.0_1.0_1.0.stl';	N=10; chooseDistance='min'; output='FA_Ellipsoid_2.0_1.0_1.0.txt';	visualise=true;

%% Option 2: Load particle shape from binary 3D image
% inputGeom='ParticleGeometries/Binary_3D_Cuboid.mat';	N=10; chooseDistance='avg'; output='FA_3D_image.txt';	visualise=true;
