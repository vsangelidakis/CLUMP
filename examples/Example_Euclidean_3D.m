...
inputGeom='ParticleGeometries/Hexahedron_Coarse_Mesh.stl';	N=21; rMin=0; div=102; overlap=0.6; output='EU_hexaCoarse.txt'; visualise=true;

%% Load particle shape from binary 3D image
% inputGeom='ParticleGeometries/Binary_3D_Cube.mat';   N=21; rMin=0; div=102; overlap=0.6; output='FM_3D_image.txt'; visualise=true;
